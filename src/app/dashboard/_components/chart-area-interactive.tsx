...
export function ChartAreaInteractive({ chartData = [], chartConfig }: { chartData: any[]; chartConfig: ChartConfig }) {
  ...
  const filteredData = chartData.filter((item) => {
    ...
    // Use the latest date in the data as reference, or fallback to today
